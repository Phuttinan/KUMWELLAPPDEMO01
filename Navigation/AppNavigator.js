...
function LightningStackScreen() {
  return (
    <LightningStack.Navigator>
      <LightningStack.Screen
        name="LightningScreen"
...
function KumwellNewsStackScreen() {
  return (
    <KumwellNewsStack.Navigator>
      <KumwellNewsStack.Screen
        name="KumwellNewsScreen"
        component={KumwellNewsScreen}
        options={{
          headerTitle: (props) => <LogoTitle {...props} />,
        }}
      />
...
const AppNavigator = () => {
  return (
    ...
    >
      <Tab.Screen
        name="Lightning Alarm"
        component={LightningStackScreen}
        options={{
          tabBarIcon: () => <Ionicons name="flash" size={25} />,
          tabBarActiveTintColor: "#ED1B24",
          tabBarInactiveTintColor: "#949599",
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: () => <Ionicons name="ios-cloud-circle" size={25} />,
        }}
      />
      <Tab.Screen
        name="Kumwell News"
        component={KumwellNewsStackScreen}
        options={{
          tabBarIcon: () => <Ionicons name="md-checkbox" size={25} />,
          tabBarActiveTintColor: "#ED1B24",
          tabBarInactiveTintColor: "#949599",
        }}
      />
